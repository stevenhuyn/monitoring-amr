...
def generate_responses(data : list, command_text : str = '', behaviour_prompt : str = 'default', gpt_model : str = 'gpt-3.5-turbo'):
    ...
    for search_object in data:
        ...
        try:
            ...
            model=gpt_model,
            messages=[
                {"role": "system", "content": behaviour}, # One shot learning
